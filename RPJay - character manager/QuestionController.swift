...
class QuestionCell: UITableViewCell {
    ...
    @IBAction func buttonPressed(_ sender: UIButton){
        ...
        case aButton:
            ...
            aAnswer.textColor = #colorLiteral(red: 0.3176470697, green: 0.07450980693, blue: 0.02745098062, alpha: 1)
            bAnswer.font = UIFont.systemFont(ofSize: 17.0)
            bAnswer.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
            cAnswer.font = UIFont.systemFont(ofSize: 17.0)
            cAnswer.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
            delegate?.setAnswer(tableViewCell: self, a: true, b: false, c: false)
        case bButton:
            aAnswer.font = UIFont.systemFont(ofSize: 17.0)
            aAnswer.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
            bAnswer.font = UIFont.boldSystemFont(ofSize: 17.0)
            bAnswer.textColor = #colorLiteral(red: 0.3176470697, green: 0.07450980693, blue: 0.02745098062, alpha: 1)
            cAnswer.font = UIFont.systemFont(ofSize: 17.0)
            cAnswer.textColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        ...
        case cButton:
            ...
            cAnswer.textColor = #colorLiteral(red: 0.3176470697, green: 0.07450980693, blue: 0.02745098062, alpha: 1)
